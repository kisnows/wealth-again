...
import AccountOperationsNew from "@/components/investment/account-operations-new";
...
export default function AccountDetailPageNew({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="container mx-auto py-8 space-y-6" data-testid="account-detail-page-new">
      {/* 账户标题和操作栏 */}
