...
export default function SocialInsurancePage() {
  ...
  const cities = [
    "Hangzhou", "Beijing", "Shanghai", "Shenzhen", 
    "Guangzhou", "Nanjing", "Chengdu", "Wuhan"
  ];

  // 模拟杭州2025年数据
  const hangzhouConfig: Omit<SocialInsuranceConfig, 'id'>[] = [
    // 社保
    { city: "Hangzhou", type: "social", category: "养老保险", employerRate: 14, employeeRate: 8, minBase: 4812, maxBase: 24930, effectiveFrom: "2025-01-01" },
    { city: "Hangzhou", type: "social", category: "医疗保险", employerRate: 9.5, employeeRate: 2, minBase: 4812, maxBase: 24930, effectiveFrom: "2025-01-01" },
    { city: "Hangzhou", type: "social", category: "失业保险", employerRate: 0.5, employeeRate: 0.5, minBase: 4812, maxBase: 24930, effectiveFrom: "2025-01-01" },
    { city: "Hangzhou", type: "social", category: "工伤保险", employerRate: 0.2, employeeRate: 0, minBase: 4812, maxBase: 24930, effectiveFrom: "2025-01-01" },
    { city: "Hangzhou", type: "social", category: "生育保险", employerRate: 0.5, employeeRate: 0, minBase: 4812, maxBase: 24930, effectiveFrom: "2025-01-01" },
    // 公积金
    { city: "Hangzhou", type: "housing", category: "住房公积金", employerRate: 12, employeeRate: 12, minBase: 2490, maxBase: 40694, effectiveFrom: "2025-07-01" },
  ];
  ...
  const getCityConfigs = (type: 'social' | 'housing') => {
    return configs.filter(config => 
      config.city === selectedCity && config.type === type
    );
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <div className="text-sm text-blue-600 mt-2 space-y-1">
                ...
                <div><strong>个人总扣除：¥1,812</strong></div>
              </div>
            </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <div className="text-sm text-green-600 mt-2 space-y-1">
                ...
                <div><strong>个人总扣除：¥3,398</strong></div>
              </div>
            </div>
            ...
            <div className="p-4 bg-orange-50 rounded-lg">
              ...
              <div className="text-sm text-orange-600 mt-2 space-y-1">
                ...
                <div><strong>个人总扣除：¥6,255</strong></div>
              </div>
            </div>
          </div>
