...
INSERT INTO "new_Account" ("baseCurrency", "createdAt", "id", "initialBalance", "name", "totalDeposits", "totalWithdrawals", "updatedAt", "userId") SELECT "baseCurrency", "createdAt", "id", "initialBalance", "name", "totalDeposits", "totalWithdrawals", "updatedAt", "userId" FROM "Account";
DROP TABLE "Account";
...
INSERT INTO "new_FxRate" ("asOf", "base", "createdAt", "id", "quote", "rate", "updatedAt") SELECT "asOf", "base", "createdAt", "id", "quote", "rate", "updatedAt" FROM "FxRate";
DROP TABLE "FxRate";
